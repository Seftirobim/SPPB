...
class Sppb2Controller extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','GetDepartemen','GetBarang','SelectKode','selectKode2','Getgudang','SelectKode3','Report','Laporan'),
	...
	public function actionLaporan(){
		...
		if (isset($_POST['Sppb2'])){
			...
			$criteria->addBetweenCondition('year',$model->firstDate, $model->lastDate);
