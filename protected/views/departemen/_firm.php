...
<div class="modal-header">
    ...
    <h4 style="color:white">Tambah Master Departemen</h4>
</div>
...
<br>
<?php $this->widget('bootstrap.widgets.TbButton', array(
    'label'=>'Buat Master Departemen',
    'type'=>'primary',
    'icon'=>'icon-pencil',
   'url'=>'/indo_everest/Departemen/create',
   'htmlOptions'=>array(
      'title'=>'Membuat Data Master Departemen'),
)); ?>
&nbsp
<?php $this->widget('bootstrap.widgets.TbButton', array(
...
<div class="well">
  <div class="form">
<h1>Update Master Departemen ID : <?php echo $model->id?></h1>
