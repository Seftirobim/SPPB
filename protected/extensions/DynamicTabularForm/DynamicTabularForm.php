...
class DynamicTabularForm extends CActiveForm {
    ...
    public function rowForm($models = array(), $rowView=null, $htmlOptions = array()) {
        ...
        //echo CHtml::button('Tambah Barang', array(
        //    'id' => $buttonId,
        //));
        ...
        $cs->registerScript("DynamicForm", "
            ...
            //for deleting rows
            $(document).on('click','.delete-row-button',function(e){
        ...
        if($this->rowViewCounter == 3){
            echo 'asdasd';
        }
    }

    public function deleteRowButton($row_id, $key, $label='Hapus', $htmlOptions = array()) {
