...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->textField($model,'nama_dept',array('readonly'=>'true','style'=>'width:150px;','value'=>$this->getName())); ?>
		<?php 
		...
		<?php echo $form->textArea($model,'message',array('rows'=>5, 'cols'=>50,'class'=>'ckeditor')); ?>
