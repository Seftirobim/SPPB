...
class DepartemenController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','InUpdate','creatu'),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Departemen'];
			if($model->save())
	...
	public function actionInUpdate(){
		$dataProvider = new CActiveDataProvider('Departemen');
	 ...
	 * @param Departemen $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='departemen-form')
		{
